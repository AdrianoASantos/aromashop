            ...
            <form role="form" action="/admin/product/create" method="post">
              <div class="box-body"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="desurl" name="desurl" placeholder="Digite a 
                    ">
                  </div>
                  <div class="form-group">
                    <label for="desproduct">Digite a descrição do produto</label>
                    <textarea  class="form-control" id="desdescription" name="desdescription" placeholder="Digite a descrição do produto"></textarea>
                  </div>
              </div>
              <!-- /.box-body -->
