          ...
          <div class="col-md-12">
            ...
            <form role="form" action="/admin/product/<?php echo htmlspecialchars( $product["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="desproduct">Url</label>
                  <input type="text" class="form-control" id="desurl" name="desurl" placeholder="Digite o nome da url" value="<?php echo htmlspecialchars( $product["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                </div>
                <div class="form-group">
                  <label for="desdescription">Digite a a descrição</label>
                  <textarea  class="form-control" id="desdescription" name="desdescription" placeholder="Digite a descrição do produto" ><?php echo htmlspecialchars( $product["desdescription"], ENT_COMPAT, 'UTF-8', FALSE ); ?></textarea>
                </div>
                <div class="form-group">
